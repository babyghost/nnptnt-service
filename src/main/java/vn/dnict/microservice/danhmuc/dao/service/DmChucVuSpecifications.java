...
public class DmChucVuSpecifications {
	public static Specification<DmChucVu> quickSearch(final String search, final Integer trangThai) {
		return new Specification<DmChucVu>() {
			...
			@Override
			public Predicate toPredicate(Root<DmChucVu> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
