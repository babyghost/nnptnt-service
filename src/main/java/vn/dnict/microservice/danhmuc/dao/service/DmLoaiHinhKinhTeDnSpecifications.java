...
public class DmLoaiHinhKinhTeDnSpecifications {
	public static Specification<DmLoaiHinhKinhTeDn> quickSearch(final String search, final Integer trangThai) {
		return new Specification<DmLoaiHinhKinhTeDn>() {
			...
			@Override
			public Predicate toPredicate(Root<DmLoaiHinhKinhTeDn> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
