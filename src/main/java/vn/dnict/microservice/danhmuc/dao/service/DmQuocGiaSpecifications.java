...
public class DmQuocGiaSpecifications {
	public static Specification<DmQuocGia> quickSearch(final String search, final Boolean trangThai) {
		return new Specification<DmQuocGia>() {
			...
			@Override
			public Predicate toPredicate(Root<DmQuocGia> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
