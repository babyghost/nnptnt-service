...
public class DmDonViTienSpecifications {
	public static Specification<DmDonViTien> quickSearch(final String search, final Integer trangThai) {
		return new Specification<DmDonViTien>() {

			/**
			 * 
			 */
			private static final long serialVersionUID = 233469736074983136L;

			@Override
			public Predicate toPredicate(Root<DmDonViTien> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
