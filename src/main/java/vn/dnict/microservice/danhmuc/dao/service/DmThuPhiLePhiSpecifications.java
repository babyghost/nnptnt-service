...
public class DmThuPhiLePhiSpecifications {
	public static Specification<DmThuPhiLePhi> quickSearch(final String search, final Integer trangThai) {
		return new Specification<DmThuPhiLePhi>() {
			...
			@Override
			public Predicate toPredicate(Root<DmThuPhiLePhi> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
