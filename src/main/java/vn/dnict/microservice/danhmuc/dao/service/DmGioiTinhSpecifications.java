...
public class DmGioiTinhSpecifications {
	public static Specification<DmGioiTinh> quickSearch(final String search, final Integer trangThai) {
		return new Specification<DmGioiTinh>() {
			...
			@Override
			public Predicate toPredicate(Root<DmGioiTinh> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
