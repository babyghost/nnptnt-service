package vn.dnict.microservice.nnptnt.ocop.chuthe.bussiness.view;
...
public class MyExcelViewChuThe extends AbstractXlsView  {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		cell.setCellStyle(styleTitleB14);
		cell.setCellValue("BÁO CÁO THÔNG TIN DOANH NGHIỆP NGÀY " + formattedString);
		sheet.addMergedRegion(new CellRangeAddress(currentRow, // first row (0-based)
				currentRow, // last row (0-based)
				0, // first column (0-based)
		...
		cell2.setCellStyle(styleHeaderB);
		cell2.setCellValue("Tên Chủ Thể");
		currentColumn++;

		cell2 = headerRow.createCell(currentColumn);
		cell2.setCellStyle(styleHeaderB);
		cell2.setCellValue("Chủ Sở Hữu" );
		currentColumn++;

		cell2 = headerRow.createCell(currentColumn);
		cell2.setCellStyle(styleHeaderB);
		cell2.setCellValue("Loại Hình ");
		currentColumn++;

		cell2 = headerRow.createCell(currentColumn);
		cell2.setCellStyle(styleHeaderB);
		cell2.setCellValue("Loại Doanh Nghiệp ");
		currentColumn++;

		cell2 = headerRow.createCell(currentColumn);
		cell2.setCellStyle(styleHeaderB);
		cell2.setCellValue("Ngành Nghề ");
		currentColumn++;
		...
		currentColumn++;
		List<DoanhNghiepData> doanhNghiepDatas = (List<DoanhNghiepData>) model
				.get("DoanhNghiepDatas");
		int stt = 1;
		if (Objects.nonNull(doanhNghiepDatas) && !doanhNghiepDatas.isEmpty()) {

			for (DoanhNghiepData doanhNghiepData : doanhNghiepDatas) {
				currentRow++;
				currentColumn = 0;
				...
				cell2.setCellValue(
						doanhNghiepData.getTen() != null ? doanhNghiepData.getTen() : "");
				currentColumn++;

				cell2 = headerRow.createCell(currentColumn);
				cell2.setCellStyle(styleCellCenter);
				cell2.setCellValue(
						doanhNghiepData.getChuSoHuu() != null ? doanhNghiepData.getChuSoHuu() : "");
				currentColumn++;

				cell2 = headerRow.createCell(currentColumn);
				cell2.setCellStyle(styleCellCenter);
				cell2.setCellValue(
						doanhNghiepData.getLoaiHinhTen() != null ? doanhNghiepData.getLoaiHinhTen() : "");
				currentColumn++;

				cell2 = headerRow.createCell(currentColumn);
				cell2.setCellStyle(styleCellCenter);
				cell2.setCellValue(
						doanhNghiepData.getLoaiDoanhNghiepTen() != null ? doanhNghiepData.getLoaiDoanhNghiepTen() : "");
				currentColumn++;

				cell2 = headerRow.createCell(currentColumn);
				cell2.setCellStyle(styleCellCenter);
				cell2.setCellValue(doanhNghiepData.getNganhNgheTen() != null ? doanhNghiepData.getNganhNgheTen() : "");
				currentColumn++;
				cell2 = headerRow.createCell(currentColumn);
				cell2.setCellStyle(styleCellCenter);
				cell2.setCellValue(
						doanhNghiepData.getDiaChi() != null ? doanhNghiepData.getDiaChi() : "");
				currentColumn++;
