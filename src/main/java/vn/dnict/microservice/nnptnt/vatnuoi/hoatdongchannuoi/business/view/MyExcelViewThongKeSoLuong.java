...
public class MyExcelViewThongKeSoLuong extends AbstractXlsView {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		cell.setCellStyle(styleTitleB14);
		cell.setCellValue("THỐNG KÊ SỐ LƯỢNG VẬT NUÔI");
		sheet.addMergedRegion(new CellRangeAddress(currentRow, // first row (0-based)
				currentRow, // last row (0-based)
				0, // first column (0-based)
				9 // last column (0-based)
		...
		cell2 = headerRow.createCell(currentColumn);
		cell2.setCellStyle(styleHeaderB);
		cell2.setCellValue("Loại vật nuôi");
		currentColumn++;
		cell2 = headerRow.createCell(currentColumn);
		cell2.setCellStyle(styleHeaderB);
		...
		List<ThongKeSoLuongChanNuoiData> thongKeSoLuongChanNuoiDatas = (List<ThongKeSoLuongChanNuoiData>) model
				.get("thongKeSoLuongChanNuoiDatas");
		int stt = 1;
		
		System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++"+thongKeSoLuongChanNuoiDatas	+"--------------------------------------");
		if (Objects.nonNull(thongKeSoLuongChanNuoiDatas) && !thongKeSoLuongChanNuoiDatas.isEmpty()) {

			for (ThongKeSoLuongChanNuoiData thongKeSoLuongChanNuoiData : thongKeSoLuongChanNuoiDatas) {
						...
						cell2.setCellValue(
								thongKeSoLuongChanNuoiData.getNam() != null ? thongKeSoLuongChanNuoiData.getNam()
										: "");
						currentColumn++;
						System.out.println(thongKeSoLuongChanNuoiData.getNam()+"------------------------");
						
						cell2 = headerRow.createCell(currentColumn);
						cell2.setCellStyle(styleCellLeft);
						cell2.setCellValue(
								thongKeSoLuongChanNuoiData.getQuy() != null ? thongKeSoLuongChanNuoiData.getQuy().toString()
										: "");
						currentColumn++;
						...
						cell2.setCellStyle(styleCellLeft);
						cell2.setCellValue(
								thongKeSoLuongChanNuoiData.getLoaiVatNuoiTen() != null ? thongKeSoLuongChanNuoiData.getLoaiVatNuoiTen()
										: "");
						currentColumn++;
						...
						cell2.setCellStyle(styleCellLeft);
						cell2.setCellValue(
								thongKeSoLuongChanNuoiData.getTongSoLuongVatNuoi() != null ? thongKeSoLuongChanNuoiData.getTongSoLuongVatNuoi()
										: "");
						currentColumn++;
						...
						cell2.setCellStyle(styleCellLeft);
						cell2.setCellValue(
								thongKeSoLuongChanNuoiData.getTongSlVatNuoiXuat() != null ? thongKeSoLuongChanNuoiData.getTongSlVatNuoiXuat()
										: "");
						currentColumn++;
						...
						cell2.setCellStyle(styleCellLeft);
						cell2.setCellValue(
								thongKeSoLuongChanNuoiData.getTongSanLuongXuat() != null ? thongKeSoLuongChanNuoiData.getTongSanLuongXuat()
										: "");
						currentColumn++;
