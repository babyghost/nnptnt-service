package vn.dnict.microservice.nnptnt.kiemsoatgietmo.thongtingietmo.business.view;
...
public class MyExcelViewTongHopSoLuongThang {
private DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		cell.setCellStyle(styleTitleB14);
		cell.setCellValue("Báo cáo thống kê số lượng giết mổ động vật theo ngày ");
		sheet.addMergedRegion(new CellRangeAddress(currentRow, // first row (0-based)
				currentRow, // last row (0-based)
				0, // first column (0-based)
				5 // last column (0-based)
		...
		if (Objects.nonNull(thongKeSoLuongDatas) && !thongKeSoLuongDatas.isEmpty()) {
			...
			for (ThongKeSoLuongData thongKeSoLuongData : thongKeSoLuongDatas) {
				currentRow++;
				currentColumn = 0;
				
				headerRow = sheet.createRow(currentRow);
				String ngay = "";
				if(Objects.nonNull(thongKeSoLuongData.getNgayThang())) {
					ngay = formatter.format(thongKeSoLuongData.getNgayThang());
				}
				cell2 = headerRow.createCell(currentColumn);
