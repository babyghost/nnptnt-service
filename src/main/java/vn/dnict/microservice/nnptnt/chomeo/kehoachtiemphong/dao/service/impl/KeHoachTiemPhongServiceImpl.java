...
public class KeHoachTiemPhongServiceImpl implements KeHoachTiemPhongService{
	...
	@Override
	public Page<KeHoachTiemPhong> findAll(String soKeHoach, String tenKeHoach, LocalDate ngayDuKienTuNgay,
			LocalDate ngayDuKienDenNgay, LocalDate ngayBanHanhTuNgay, LocalDate ngayBanHanhDenNgay,
			 Pageable pageable) {
		// TODO Auto-generated method stub
		return repo.findAll(KeHoachTiemPhongSpecifications.quickSearch(soKeHoach, tenKeHoach, ngayDuKienTuNgay, ngayDuKienDenNgay, ngayBanHanhTuNgay, ngayBanHanhDenNgay),pageable);
	}
