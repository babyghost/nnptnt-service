...
public class MyExcelViewThongKeHopDong  extends AbstractXlsView{
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		cell.setCellStyle(styleTitleB14);
		cell.setCellValue("BÁO CÁO THÔNG TIN HỢP ĐỒNG DOANH NGHIỆP NGÀY " + formattedString);
		sheet.addMergedRegion(new CellRangeAddress(currentRow, // first row (0-based)
				currentRow, // last row (0-based)
				0, // first column (0-based)
		...
		cell2.setCellStyle(styleHeaderB);
		cell2.setCellValue("Tên Hợp Đồng");
		currentColumn++;

		cell2 = headerRow.createCell(currentColumn);
		cell2.setCellStyle(styleHeaderB);
		cell2.setCellValue("Loại Hợp Đồng" );
		currentColumn++;

		cell2 = headerRow.createCell(currentColumn);
		cell2.setCellStyle(styleHeaderB);
		cell2.setCellValue("Đợt Thanh Toán");
		currentColumn++;

		cell2 = headerRow.createCell(currentColumn);
		cell2.setCellStyle(styleHeaderB);
		cell2.setCellValue("Ngày Thanh Toán ");
		currentColumn++;

		cell2 = headerRow.createCell(currentColumn);
		cell2.setCellStyle(styleHeaderB);
		cell2.setCellValue("Đơn Vị Thực Hiện ");
		currentColumn++;


		cell2 = headerRow.createCell(currentColumn);
		cell2.setCellStyle(styleHeaderB);
		cell2.setCellValue("Cá Nhân Thực Hiện ");
		currentColumn++;
