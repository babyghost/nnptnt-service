...
public class DmNganhHangSpecifications {
	public static Specification<DmNganhHang> quickSearch(final String ten, final Boolean trangThai) {
		return new Specification<DmNganhHang>() {

			private static final long serialVersionUID = -4615834727542993669L;

			@Override
			public Predicate toPredicate(Root<DmNganhHang> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
