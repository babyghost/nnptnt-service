...
public class PhanTieuChiSpecifications {
	public static Specification<PhanTieuChi> quickSearch(final String ten, final Boolean trangThai) {
		return new Specification<PhanTieuChi>() {

			private static final long serialVersionUID = -4615834727542993669L;

			@Override
			public Predicate toPredicate(Root<PhanTieuChi> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
