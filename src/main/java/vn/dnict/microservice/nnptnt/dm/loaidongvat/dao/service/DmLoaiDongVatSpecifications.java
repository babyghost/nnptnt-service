...
public class DmLoaiDongVatSpecifications {
	public static Specification<DmLoaiDongVat> quickSearch(final String search, final Integer trangThai) {
		return new Specification<DmLoaiDongVat>() {

			private static final long serialVersionUID = -4615834727542993669L;

			@Override
			public Predicate toPredicate(Root<DmLoaiDongVat> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
