...
public class DmPhanHangSpecifications {
	public static Specification<DmPhanHang> quickSearch(final String ten, final Boolean trangThai) {
		return new Specification<DmPhanHang>() {

			private static final long serialVersionUID = -4615834727542993669L;

			@Override
			public Predicate toPredicate(Root<DmPhanHang> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
