...
public class DmLoaiDoanhNghiepOCOPSpecifications {
	public static Specification<DmLoaiDoanhNghiepOCOP> quickSearch(final String ten, final Integer trangThai) {
		return new Specification<DmLoaiDoanhNghiepOCOP>() {

			private static final long serialVersionUID = -4615834727542993669L;

			@Override
			public Predicate toPredicate(Root<DmLoaiDoanhNghiepOCOP> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
