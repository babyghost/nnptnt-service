...
import vn.dnict.microservice.core.dao.service.CoreMessageService;
import vn.dnict.microservice.core.data.CoreMessageData;
...
public class CoreMessageBusiness {
	...
	public CoreMessage create(CoreMessageData modelInput) {
		...
		coreMessage.setXemBaoCao(modelInput.getIsXemBaoCao());
